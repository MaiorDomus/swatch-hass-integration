...
documentation](https://github.com/MaiorDomus/swatch/)
for full installation instructions of this integration.

## Documentation

For full usage instructions, please see the [central Swatch documentation](https://github.com/MaiorDomus/swatch/).
